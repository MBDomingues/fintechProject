...
<div class="container pb-5">
    ...
    <div class="card shadow m-5">
        <div class="card-body">
            <h5 class="card-title">Cadastrar Meta</h5>
            ...
            <c:if test="${not empty erroMetas}">
                <div class="alert alert-success ms-2 me-2 m-auto mt-2">
                        ${erroMetas}
                </div>
            </c:if>
            <form action="metas?acao=cadastrar" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="valor_atual" class="form-control" id="valor_atual" required />
                </div>
